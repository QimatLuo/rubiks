...
void main() {
	...
	`;let i=document.querySelector(`#cube-stage`);if(!i)throw Error(`Missing #cube-stage container`);return{scrambleButton:document.querySelector(`#scramble-button`),workspaceToggleButton:document.querySelector(`#workspace-toggle-button`),repeatLastButton:document.querySelector(`#repeat-last-button`),historyPrevButton:document.querySelector(`#history-prev-button`),historyNextButton:document.querySelector(`#history-next-button`),historyListEl:document.querySelector(`#move-history-list`),helpToggleButton:document.querySelector(`#help-toggle-button`),helpCloseButton:document.querySelector(`#help-close-button`),helpPanelEl:document.querySelector(`#help-panel`),mobileTurnMenuEl:document.querySelector(`#mobile-turn-menu`),mobileTurnTargetEl:document.querySelector(`#mobile-turn-target`),mobileTurnOptionAButton:document.querySelector(`#mobile-turn-option-a`),mobileTurnOptionBButton:document.querySelector(`#mobile-turn-option-b`),mobileTurnOptionCButton:document.querySelector(`#mobile-turn-option-c`),mobileTurnOptionDButton:document.querySelector(`#mobile-turn-option-d`),mobileTurnBackButton:document.querySelector(`#mobile-turn-back-button`),mobileTurnCancelButton:document.querySelector(`#mobile-turn-cancel-button`),cubeStageEl:i}},bc=new Set([`r`,`F`,`u`,`U`,`d`,`D`,`e`,`E`]),xc=(e,t)=>t?e===`U`||e===`u`||e===t?{allowed:!0}:{allowed:!1,message:`工作區已移動，僅可做 ${t} 或 U/U'`}:bc.has(e)?{allowed:!0}:{allowed:!1,message:`工作區剛啟用，僅可做 R、F'、U、U'、D、D'、E、E'`},Sc=e=>[{...e[0]},{...e[1]},{...e[2]}],Cc=(e,t)=>{let n=e=>e.map(e=>`${e.x},${e.y},${e.z}`).sort().join(`|`);return n(e)===n(t)},wc=(e,t)=>t.layer===0?e[t.axis]===0:e[t.axis]===t.layer,Tc=(e,t)=>{let n=dc(t.notation,t.clockwise),r=t.axis===`x`?new G(1,0,0):t.axis===`y`?new G(0,1,0):new G(0,0,1),i=new G(e.x,e.y,e.z).applyAxisAngle(r,n);return{x:Math.round(i.x),y:Math.round(i.y),z:Math.round(i.z)}},Ec={x:{axis:`x`,layer:0},y:{axis:`y`,layer:0},z:{axis:`z`,layer:0}},Dc=e=>{Object.assign(e,Ec)},Oc=()=>`
...
`,kc=e=>e.map(e=>e.replace(/面$/,``)).join(`/`),Ac=e=>{let{targets:t,pieceFaceInfoByNotation:n,centerFaceInfoByNotation:r,middleLayerNotation:i}=e,a=t.map(e=>{let t=n[e.notation];return t?`${t.label}面`:null});if(a[0]===null||a[1]===null)return null;let o=t.map(e=>{let t=r[e.notation];return t?{label:`${t.label}面`,faceColor:t.faceColor,notation:e.notation}:null});return o[0]===null||o[1]===null?null:{targetText:kc([a[0],a[1]]),options:[o[0],o[1],{label:`中間層`,notation:i}]}},jc=e=>{let{targets:t,pieceFaceInfoByNotation:n,centerFaceInfoByNotation:r}=e,i=t.map(e=>{let t=n[e.notation];return t?`${t.label}面`:null});if(i[0]===null||i[1]===null||i[2]===null)return null;let a=t.map(e=>{let t=r[e.notation];return t?{label:`${t.label}面`,faceColor:t.faceColor,notation:e.notation}:null});return a[0]===null||a[1]===null||a[2]===null?null:{targetText:kc([i[0],i[1],i[2]]),options:[a[0],a[1],a[2]]}},Mc={x:{[-1]:{axis:`x`,sign:-1,notation:`l`},1:{axis:`x`,sign:1,notation:`r`}},y:{[-1]:{axis:`y`,sign:-1,notation:`d`},1:{axis:`y`,sign:1,notation:`u`}},z:{[-1]:{axis:`z`,sign:-1,notation:`b`},1:{axis:`z`,sign:1,notation:`f`}}},Nc=e=>{let t=[[`x`,e.x],[`y`,e.y],[`z`,e.z]].filter(([,e])=>e!==0);if(t.length!==2)return null;let[n,r]=t,[i,a]=n,[o,s]=r;return Math.abs(a)!==1&&Math.abs(s)!==1||Math.abs(a)+Math.abs(s)!==2?null:[Mc[i][a],Mc[o][s]]},Pc=e=>{let t=[[`x`,e.x],[`y`,e.y],[`z`,e.z]];return t.some(([,e])=>Math.abs(e)!==1)?null:t.map(([e,t])=>Mc[e][t])},Fc=e=>{let t=[[`x`,e.x],[`y`,e.y],[`z`,e.z]],n=t.filter(([,e])=>e===0);if(n.length!==1)return null;let r=t.filter(([,e])=>e!==0);if(r.length!==2||r.some(([,e])=>Math.abs(e)!==1))return null;let[i]=n[0];return i===`x`?`m`:i===`y`?`e`:`s`},Ic=(e,t)=>(e.sign===1?t:!t)?e.axis:e.axis.toUpperCase(),Lc=(e,t)=>t?e:e.toUpperCase(),Rc=()=>({renderView:Oc,registerMoveBindings:Dc}),zc=()=>{let e=[],t=[],n=0,r=null,i=null,a=e=>e===e.toLowerCase()?e.toUpperCase():e.toLowerCase();return{initialize:t=>{e.push(t)},trimFutureHistory:()=>{n!==t.length&&(t.splice(n),e.splice(n+1))},appendMove:(r,i)=>{t.push(r),e.push(i),n=t.length},queueJump:e=>{r=e},queueStep:e=>{i=e},consumeQueuedJump:()=>{if(r===null)return null;let e=r;return r=null,e},consumeQueuedStep:()=>{if(i===null)return null;let e=i;return i=null,e},jumpTo:t=>{let r=e[t];if(r!==void 0)return n=t,r},getStepInstruction:e=>{if(e===1)return n>=t.length?null:{notation:t[n],targetIndex:n+1};if(n<=0)return null;let r=t[n-1];return r?{notation:a(r),targetIndex:n-1}:null},setCurrentIndex:e=>e<0||e>t.length?!1:(n=e,!0),getViewItems:()=>{let e=[{index:0,notation:null,isCurrent:n===0}];for(let r=0;r<t.length;r+=1)e.push({index:r+1,notation:t[r],isCurrent:n===r+1});return e},getNotationAtIndex:e=>e<=0||e>t.length?null:t[e-1]??null,getDebugState:()=>({moveHistory:[...t],currentHistoryIndex:n,queuedHistoryRestoreIndex:r,queuedStepDirection:i,stateCount:e.length})}},Bc=e=>{let t=e.toUpperCase();return e===e.toLowerCase()?t:`${t}'`},Vc=({historyListEl:e,captureState:t,restoreState:n,clearPendingMoves:r,setStatus:i,isAnimating:a,onHistoryItemSelect:o})=>{let s=zc(),c=()=>{if(!e)return;let t=e.parentElement;t&&(t.scrollTop=t.scrollHeight),e.scrollLeft=e.scrollWidth},l=()=>{e&&(e.innerHTML=s.getViewItems().map(e=>{let t=e.isCurrent?` is-current`:``,n=e.notation===null?`起始`:Bc(e.notation);return`<button type="button" class="history-item${t}" data-history-index="${e.index}">${n}</button>`}).join(``),c())},u=e=>{let t=s.jumpTo(e);return t!==void 0&&(r(),n(t),l(),i(`已復原到步驟 ${e}`),!0)},d=e=>{if(a()){s.queueJump(e),r(),i(`正在等待目前轉動完成，之後復原到步驟 ${e}`);return}u(e)&&i(`待命`)};return{initialize:()=>{s.initialize(t()),l()},onBeforeEnqueueMove:()=>{s.trimFutureHistory(),l()},onMoveCompleted:(e,n={})=>{if(typeof n.historyTargetIndex==`number`){s.setCurrentIndex(n.historyTargetIndex),l();let e=s.consumeQueuedStep();if(e!==null){let t=s.getStepInstruction(e);if(t)return i(`待命`),t}return i(`待命`),null}s.appendMove(e,t()),l();let r=s.consumeQueuedStep();if(r!==null){let e=s.getStepInstruction(r);if(e)return i(`待命`),e}let a=s.consumeQueuedJump();return a===null?null:(u(a),i(`待命`),null)},attachClickHandler:()=>{e?.addEventListener(`click`,e=>{let t=e.target;if(!t)return;let n=t.closest(`.history-item`);if(!n)return;let r=n.dataset.historyIndex;if(typeof r!=`string`)return;let i=Number.parseInt(r,10);if(!Number.isFinite(i))return;let a=s.getNotationAtIndex(i);if(o){o({index:i,notation:a});return}d(i)})},requestJump:d,requestStep:e=>a()?(s.queueStep(e),r(),i(`正在等待目前轉動完成，之後切換歷史步驟`),null):s.getStepInstruction(e),getDebugState:s.getDebugState}},Hc=e=>({captureState:()=>e.map(e=>({position:e.position.clone(),quaternion:e.quaternion.clone()})),restoreState:t=>{for(let[n,r]of e.entries()){let e=t[n];e&&(r.position.copy(e.position),r.quaternion.copy(e.quaternion),r.rotation.setFromQuaternion(e.quaternion,`XYZ`))}}}),Uc=document.querySelector(`#app`);if(!Uc)throw Error(`Missing #app container`);var Wc=`2026-08-16T19:32:20+08:00`,Gc=Rc(),{scrambleButton:Kc,workspaceToggleButton:qc,repeatLastButton:Jc,historyPrevButton:Yc,historyNextButton:Xc,historyListEl:Zc,helpToggleButton:Qc,helpCloseButton:$c,helpPanelEl:el,mobileTurnMenuEl:tl,mobileTurnTargetEl:nl,mobileTurnOptionAButton:rl,mobileTurnOptionBButton:il,mobileTurnOptionCButton:al,mobileTurnOptionDButton:ol,mobileTurnBackButton:sl,mobileTurnCancelButton:cl,cubeStageEl:ll}=yc({app:Uc,xyzMarkup:Gc.renderView(),latestCommitTimestamp:Wc}),ul=[rl,il,al,ol],dl=new cc({antialias:!0});dl.setPixelRatio(Math.min(globalThis.devicePixelRatio,2)),dl.setSize(ll.clientWidth,ll.clientHeight),ll.appendChild(dl.domElement);var fl=new zr;fl.background=new J(`#0f172a`);var pl=new Ar(45,ll.clientWidth/ll.clientHeight,.1,100);pl.position.set(6,6,7),pl.lookAt(0,0,0);var ml=pl.position.clone().normalize(),hl=new Bi(`#ffffff`,.65);fl.add(hl);var gl=new zi(`#ffffff`,.9);gl.position.set(8,10,12),fl.add(gl);var _l=new zi(`#7dd3fc`,.35);_l.position.set(-8,-3,-10),fl.add(_l);var vl=new Ir;fl.add(vl);var yl=new Ir;fl.add(yl);var bl=[],xl=new WeakMap,Sl=.5,Cl=1.5,wl=null,Tl=.95,Q=1.05,El=[{x:1,y:1,z:1},{x:1,y:0,z:1},{x:1,y:-1,z:1}],Dl=new vt(new G(-1.05-Tl/2,-1.05-Tl/2,-1.05-Tl/2),new G(1.525,1.525,1.525)),Ol=[],kl={right:`#f97316`,left:`#ef4444`,up:`#facc15`,down:`#f8fafc`,front:`#22c55e`,back:`#3b82f6`,inner:`#111827`},Al={[new J(kl.right).getHexString()]:`橘色`,[new J(kl.left).getHexString()]:`紅色`,[new J(kl.up).getHexString()]:`黃色`,[new J(kl.down).getHexString()]:`白色`,[new J(kl.front).getHexString()]:`綠色`,[new J(kl.back).getHexString()]:`藍色`},jl=[{materialIndex:0,normal:new G(1,0,0)},{materialIndex:1,normal:new G(-1,0,0)},{materialIndex:2,normal:new G(0,1,0)},{materialIndex:3,normal:new G(0,-1,0)},{materialIndex:4,normal:new G(0,0,1)},{materialIndex:5,normal:new G(0,0,-1)}],Ml=e=>{let t=Math.PI/2;return Math.round(e/t)*t},Nl=new _i({color:`#ffffff`,dashSize:.13,gapSize:.08,transparent:!0,opacity:.95}),Pl=(e,t,n)=>{let r=new _r(e,t,n),i=new fi(r);return r.dispose(),i},Fl=new oi(Pl(1,1,1),Nl);yl.add(Fl);var Il=e=>{let t=new G(1/0,1/0,1/0),n=new G(-1/0,-1/0,-1/0);for(let r of e){let e=r.x*Q,i=r.y*Q,a=r.z*Q;t.x=Math.min(t.x,e),t.y=Math.min(t.y,i),t.z=Math.min(t.z,a),n.x=Math.max(n.x,e),n.y=Math.max(n.y,i),n.z=Math.max(n.z,a)}return t.addScalar(-.5549999999999999),n.addScalar(.5549999999999999),{min:t,max:n}},Ll=e=>{let{min:t,max:n}=Il(e),r=n.x-t.x,i=n.y-t.y,a=n.z-t.z,o=Fl.geometry;Fl.geometry=Pl(r,i,a),o.dispose(),Fl.position.set((t.x+n.x)/2,(t.y+n.y)/2,(t.z+n.z)/2),Fl.computeLineDistances()},Rl=[{...El[0]},{...El[1]},{...El[2]}],zl=!1,Bl=null;for(let e of[Dl.min.x,Dl.max.x])for(let t of[Dl.min.y,Dl.max.y])for(let n of[Dl.min.z,Dl.max.z])Ol.push(new G(e,t,n));for(let e=-1;e<=1;e+=1)for(let t=-1;t<=1;t+=1)for(let n=-1;n<=1;n+=1){let r=new _r(Tl,Tl,Tl),i=[new mi({color:e===1?kl.right:kl.inner}),new mi({color:e===-1?kl.left:kl.inner}),new mi({color:t===1?kl.up:kl.inner}),new mi({color:t===-1?kl.down:kl.inner}),new mi({color:n===1?kl.front:kl.inner}),new mi({color:n===-1?kl.back:kl.inner})],a=new mr(r,i);xl.set(a,i.map(e=>e.color.getHex())),a.position.set(e*Q,t*Q,n*Q),vl.add(a),bl.push(a)}Ll(Rl),yl.visible=!1;var Vl=()=>{let e=Sc(El);for(let t=0;t<Rl.length;t+=1)Rl[t].x=e[t].x,Rl[t].y=e[t].y,Rl[t].z=e[t].z;Bl=null,Ll(Rl)},Hl=()=>{qc&&(qc.textContent=zl?`工作區：開`:`工作區：關`,qc.setAttribute(`aria-pressed`,zl?`true`:`false`),qc.classList.toggle(`is-active`,zl))},Ul=e=>{zl=e,zl&&Vl(),yl.visible=zl,Hl()};Hl();var Wl=(e,t)=>{let n=Array.isArray(e.material)?e.material:null,r=xl.get(e);if(!(!n||!r))for(let e=0;e<n.length;e+=1){let i=n[e];i instanceof mi&&(i.color.setHex(r[e]),t!==null&&i.color.multiplyScalar(t))}},Gl=e=>{wl=e;for(let e of bl){if(wl===null){Wl(e,null);continue}if(e===wl){Wl(e,Cl);continue}Wl(e,Sl)}},Kl=lc();Gc.registerMoveBindings(Kl);var ql=e=>{},Jl=e=>e,Yl=e=>{let t=e.toUpperCase(),n=e!==e.toLowerCase(),r=n?`${t}'`:t;return t===`X`||t===`Y`||t===`Z`?`${r} ${n?`↺`:`↻`}`:t===`U`?`${r} ${n?`→`:`←`}`:t===`D`?`${r} ${n?`←`:`→`}`:t===`R`?`${r} ${n?`↓`:`↑`}`:t===`F`||t===`L`?`${r} ${n?`↑`:`↓`}`:t===`B`?`${r} ${n?`↓`:`↑`}`:t===`E`||t===`S`?`${r} ${n?`←`:`→`}`:t===`M`?`${r} ${n?`↑`:`↓`}`:r},Xl=e=>`已選面：${e.label}（再選轉動方向）`,Zl=e=>e.axis===`x`?e.sign===1?`r`:`l`:e.axis===`y`?e.sign===1?`u`:`d`:e.sign===1?`f`:`b`,Ql=new ea,$l=new W,$=null,eu=[],tu=()=>$!==null,nu=()=>{let e=eu.length>0;sl&&(sl.hidden=!e),cl&&(cl.hidden=e)},ru=()=>{tl&&(tl.hidden=!0,Gl(null),$=null,eu.length=0,nu())},iu=e=>{e&&(e.style.removeProperty(`background-color`),e.style.removeProperty(`border-color`),e.style.removeProperty(`color`))},au=(e,t)=>{if(!e)return;if(!t){iu(e);return}let n=new J(t),r=n.r*.2126+n.g*.7152+n.b*.0722,i=n.clone().multiplyScalar(.72).getStyle();e.style.backgroundColor=n.getStyle(),e.style.borderColor=i,e.style.color=r>.66?`#0f172a`:`#f8fafc`},ou=e=>{let t=()=>{for(let e of ul)iu(e)};if(e.kind===`edge-face`){au(rl,e.options[0].faceColor),au(il,e.options[1].faceColor),iu(al),iu(ol);return}if(e.kind===`corner-face`){au(rl,e.options[0].faceColor),au(il,e.options[1].faceColor),au(al,e.options[2].faceColor),iu(ol);return}if(e.kind===`center-direction`){t();return}t()},su=e=>{Qc?.setAttribute(`aria-expanded`,e?`true`:`false`)},cu=()=>{el&&(el.hidden=!0,su(!1))},lu=()=>{el&&(el.hidden=!1,su(!0))},uu=(e,t,n,r=!1)=>{if(tl){r?$&&eu.push($):eu.length=0,$=e,nu(),nl&&(nl.textContent=t);for(let e=0;e<ul.length;e+=1){let t=ul[e];if(!t)continue;let r=n[e];if(r===void 0){t.hidden=!0;continue}t.textContent=r,t.hidden=!1}ou(e),tl.hidden=!1}},du=(e,t)=>{let n=Ic(e,!0),r=Ic(e,!1),i=Zl(e),a=Lc(i,!0),o=Lc(i,!1);uu({kind:`center-direction`,selection:e,colorLabel:t},Jl(t),[Yl(n),Yl(r),Yl(a),Yl(o)],!1)},fu=(e,t)=>{uu({kind:`edge-face`,options:e,targetText:t},t,[e[0].label,e[1].label,e[2].label],!1)},pu=(e,t)=>{uu({kind:`corner-face`,options:e,targetText:t},t,[e[0].label,e[1].label,e[2].label],!1)},mu=(e,t=!1)=>{let n=Lc(e.notation,!0),r=Lc(e.notation,!1);uu({kind:`face-direction`,face:e},Xl(e),[Yl(n),Yl(r)],t)},hu=e=>{let t=e.notation?`已選動作：${Yl(e.notation)}`:`已選起始狀態`;uu({kind:`history-action`,index:e.index,notation:e.notation},t,[`再一次`,`恢復狀態`,`逆做`],!1)},gu=e=>{if(!$){ru();return}if($.kind===`center-direction`){let t=Ic($.selection,!0),n=Ic($.selection,!1),r=Zl($.selection);ju([t,n,Lc(r,!0),Lc(r,!1)][e],{allowDuringMenu:!0}),ru();return}if($.kind===`edge-face`||$.kind===`corner-face`){let t=$.options[e];if(!t){ru();return}mu(t,!0);return}if($.kind===`history-action`){if(e===0){if(!$.notation){ru();return}ju($.notation,{allowDuringMenu:!0}),ru();return}if(e===1){ku.requestJump($.index),ru();return}if(e===2){if(!$.notation){ru();return}ju(Pu($.notation),{allowDuringMenu:!0}),ru();return}ru();return}if(e===0||e===1){ju(Lc($.face.notation,e===0),{allowDuringMenu:!0}),ru();return}ru()},_u=e=>{let t=Math.round(e/Q);return Math.abs(e-t*Q)<.001?t:null},vu=e=>{let t=_u(e.position.x),n=_u(e.position.y),r=_u(e.position.z);return t===null||n===null||r===null?null:{x:t,y:n,z:r}},yu=e=>{let t=vu(e);if(!t)return null;let{x:n,y:r,z:i}=t;return Math.abs(n)===1&&r===0&&i===0?{axis:`x`,sign:n}:Math.abs(r)===1&&n===0&&i===0?{axis:`y`,sign:r}:Math.abs(i)===1&&n===0&&r===0?{axis:`z`,sign:i}:null},bu=e=>{let t=Math.abs(e.x),n=Math.abs(e.y),r=Math.abs(e.z),i=Math.max(t,n,r);return i<.85?null:t===i?e.x>=0?`r`:`l`:n===i?e.y>=0?`u`:`d`:e.z>=0?`f`:`b`},xu=e=>{let t={},n=Array.isArray(e.material)?e.material:null;if(!n)return t;for(let r of jl){let i=n[r.materialIndex];if(!(i instanceof mi))continue;let a=bu(r.normal.clone().applyQuaternion(e.quaternion));if(!a)continue;let o=Al[i.color.getHexString()];o&&(t[a]={label:o,faceColor:`#${i.color.getHexString()}`})}return t},Su=()=>{let e={};for(let t of bl){let n=yu(t);if(!n)continue;let r=Zl(n),i=xu(t)[r];i&&(e[r]=i)}return e},Cu=e=>{let t=vu(e);if(!t)return null;let n=Nc(t);if(!n)return null;let r=Fc(t);return r?Ac({targets:n,pieceFaceInfoByNotation:xu(e),centerFaceInfoByNotation:Su(),middleLayerNotation:r}):null},wu=e=>{let t=vu(e);if(!t)return null;let n=Pc(t);return n?jc({targets:n,pieceFaceInfoByNotation:xu(e),centerFaceInfoByNotation:Su()}):null},Tu=e=>new Promise(t=>setTimeout(t,e)),Eu=Hc(bl),Du,Ou=null,ku=Vc({historyListEl:Zc,captureState:Eu.captureState,restoreState:Eu.restoreState,clearPendingMoves:()=>{Du.clearPending()},setStatus:ql,isAnimating:()=>Du.isAnimating(),onHistoryItemSelect:e=>{tu()||hu(e)}}),Au=e=>{let{axis:t,layer:n,notation:r}=e;if(n===0){let e=r.toLowerCase();return e===`x`||e===`y`||e===`z`?bl:bl.filter(e=>Math.abs(e.position[t])<.001)}let i=n*Q;return bl.filter(e=>Math.abs(e.position[t]-i)<.001)};Du=fc({runMove:(e,t)=>{let{axis:n,layer:r,clockwise:i,notation:a}=e,o=Sc(Rl),s=Au(e),c=a.toLowerCase(),l=zl&&(c===`r`||c===`f`)&&Rl.every(t=>wc(t,e));if(s.length===0){t();return}let u=new Ir;vl.add(u);for(let e of s)u.attach(e);`${a}`;let d=dc(a,i),f=performance.now(),p=r=>{let i=r-f,c=Math.min(i/220,1),m=1-(1-c)**3;if(u.rotation[n]=d*m,c<1){requestAnimationFrame(p);return}for(let e of s){vl.attach(e),e.position.set(Math.round(e.position.x/Q)*Q,Math.round(e.position.y/Q)*Q,Math.round(e.position.z/Q)*Q);let t=new tn().setFromQuaternion(e.quaternion,`XYZ`);e.rotation.set(Ml(t.x),Ml(t.y),Ml(t.z),`XYZ`)}if(vl.remove(u),l){for(let t=0;t<Rl.length;t+=1){let n=Tc(Rl[t],e);Rl[t].x=n.x,Rl[t].y=n.y,Rl[t].z=n.z}Ll(Rl),Bl=Bl&&a===Bl.requiredInverseNotation&&Cc(Rl,Bl.restorePositions)?null:{requiredInverseNotation:mc(a),restorePositions:o}}Ou=e.notation;let h=ku.onMoveCompleted(e.notation,{historyTargetIndex:e.historyTargetIndex});h&&ju(h.notation,{skipHistoryTrim:!0,historyTargetIndex:h.targetIndex}),t()};requestAnimationFrame(p)},onIdle:()=>void 0});var ju=(e,t={})=>{if(tu()&&!t.allowDuringMenu)return;let n=e.toLowerCase(),r=Kl[n];if(!r)return;if(zl){let t=xc(e,Bl?.requiredInverseNotation??null);if(!t.allowed){t.message;return}}t.skipHistoryTrim||ku.onBeforeEnqueueMove();let i=e===n;Du.enqueue({axis:r.axis,layer:r.layer,clockwise:i,notation:e,historyTargetIndex:t.historyTargetIndex})},Mu=e=>{if(tu())return;let t=ku.requestStep(e);t&&ju(t.notation,{skipHistoryTrim:!0,historyTargetIndex:t.targetIndex})},Nu=e=>{for(let t of e)ju(t)},Pu=e=>e.split(``).reverse().map(e=>mc(e)).join(``),Fu=()=>{for(let e of bl){let t=Math.round(e.position.x/Q)*Q,n=Math.round(e.position.y/Q)*Q,r=Math.round(e.position.z/Q)*Q;if(Math.abs(e.position.x-t)>.001||Math.abs(e.position.y-n)>.001||Math.abs(e.position.z-r)>.001)return!1;let i=new tn().setFromQuaternion(e.quaternion,`XYZ`);if(Math.abs(i.x-Ml(i.x))>.001||Math.abs(i.y-Ml(i.y))>.001||Math.abs(i.z-Ml(i.z))>.001)return!1}return bl.every(e=>{let t=e.userData.home;return t?Math.abs(e.position.x-t.x)<.001&&Math.abs(e.position.y-t.y)<.001&&Math.abs(e.position.z-t.z)<.001&&Math.abs(e.quaternion.x)<.001&&Math.abs(e.quaternion.y)<.001&&Math.abs(e.quaternion.z)<.001&&Math.abs(e.quaternion.w-1)<.001:!1})},Iu=async()=>{for(;Du.isAnimating()||Du.getQueueLength()>0;)await Tu(20)},Lu=gc({setStatus:ql,enqueueAlgorithm:Nu});for(let e of bl)e.userData.home={x:e.position.x,y:e.position.y,z:e.position.z};ku.initialize(),ku.attachClickHandler();var Ru=()=>tu()||Du.isAnimating()||Du.getQueueLength()>0?!1:(Ul(!zl),!0);qc?.addEventListener(`click`,()=>{Ru()}),globalThis.addEventListener(`keydown`,e=>{if(e.key!==`w`&&e.key!==`W`)return;let t=e.target;t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement||t instanceof HTMLElement&&t.isContentEditable||Ru()&&e.preventDefault()}),Kc?.addEventListener(`click`,()=>{tu()||globalThis.confirm(`確定要打亂嗎？`)&&Lu.triggerScramble()}),Jc?.addEventListener(`click`,()=>{tu()||Ou&&ju(Ou)}),Yc?.addEventListener(`click`,()=>{Mu(-1)}),Xc?.addEventListener(`click`,()=>{Mu(1)}),Qc?.addEventListener(`click`,()=>{if(el?.hidden){lu();return}cu()}),$c?.addEventListener(`click`,()=>{cu()}),el?.addEventListener(`click`,e=>{e.target===el&&cu()}),rl?.addEventListener(`click`,()=>{gu(0)}),il?.addEventListener(`click`,()=>{gu(1)}),al?.addEventListener(`click`,()=>{gu(2)}),ol?.addEventListener(`click`,()=>{gu(3)}),sl?.addEventListener(`click`,()=>{if(!$){ru();return}let e=eu.pop();if(!e){ru();return}if(e.kind===`center-direction`){du(e.selection,e.colorLabel);return}if(e.kind===`edge-face`){fu(e.options,e.targetText);return}if(e.kind===`corner-face`){pu(e.options,e.targetText);return}if(e.kind===`history-action`){hu({index:e.index,notation:e.notation});return}mu(e.face,!1)}),cl?.addEventListener(`click`,()=>{ru()}),tl?.addEventListener(`click`,e=>{e.target===tl&&ru()}),dl.domElement.addEventListener(`click`,e=>{if(tu())return;let t=dl.domElement.getBoundingClientRect();$l.x=(e.clientX-t.left)/t.width*2-1,$l.y=-((e.clientY-t.top)/t.height)*2+1,Ql.setFromCamera($l,pl);let n=Ql.intersectObjects(bl,!1);if(n.length===0)return;let r=n.map(e=>e.object).find(e=>e instanceof mr);if(!r)return;let i=yu(r);if(i){let e=Zl(i),t=xu(r)[e]?.label;if(!t)return;Gl(r),du(i,t);return}let a=Cu(r);if(a){Gl(r),fu(a.options,a.targetText);return}let o=wu(r);o&&(Gl(r),pu(o.options,o.targetText))}),pc({moveMap:Kl,enqueueMoveByNotation:ju});var zu=()=>{dl.render(fl,pl),requestAnimationFrame(zu)};zu();var Bu=()=>{let e=Math.max(ll.clientWidth,1),t=Math.max(ll.clientHeight,1);pl.aspect=e/t;let n=e=>{pl.position.copy(ml).multiplyScalar(e),pl.lookAt(0,0,0),pl.updateMatrixWorld();let t=0,n=0;for(let e of Ol){let r=e.clone().project(pl);t=Math.max(t,Math.abs(r.x)),n=Math.max(n,Math.abs(r.y))}return Math.max(t,n)},r=2,i=24;for(let e=0;e<22;e+=1){let e=(r+i)/2;n(e)>.96?r=e:i=e}pl.position.copy(ml).multiplyScalar(i),pl.lookAt(0,0,0),pl.updateProjectionMatrix(),dl.setSize(e,t)};Bu(),new ResizeObserver(()=>{Bu()}).observe(ll),globalThis.addEventListener(`resize`,()=>{Bu()}),_c({enqueueMoveByNotation:ju,enqueueAlgorithm:Nu,invertAlgorithm:Pu,isSolved:Fu,waitForIdle:Iu,getLastScramble:Lu.getLastScramble,getQueueLength:()=>Du.getQueueLength(),isAnimating:()=>Du.isAnimating()});