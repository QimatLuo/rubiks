...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fa(){return new Tr({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:La(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ia(){return new Tr({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:La(),fragmentShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		<div id="help-panel" class="help-panel" hidden>
			<div class="help-card" role="dialog" aria-modal="true" aria-labelledby="help-title">
				...
				${t}
				<p class="help-last-updated">最後更新時間：<time id="last-updated-time" datetime="${n??``}">${r}</time></p>
			</div>
		</div>
	`;let i=document.querySelector(`#cube-stage`);if(!i)throw Error(`Missing #cube-stage container`);return{scrambleButton:document.querySelector(`#scramble-button`),workspaceToggleButton:document.querySelector(`#workspace-toggle-button`),repeatLastButton:document.querySelector(`#repeat-last-button`),historyPrevButton:document.querySelector(`#history-prev-button`),historyNextButton:document.querySelector(`#history-next-button`),statusMessageEl:document.querySelector(`#status-message`),historyListEl:document.querySelector(`#move-history-list`),helpToggleButton:document.querySelector(`#help-toggle-button`),helpCloseButton:document.querySelector(`#help-close-button`),helpPanelEl:document.querySelector(`#help-panel`),mobileTurnMenuEl:document.querySelector(`#mobile-turn-menu`),mobileTurnTargetEl:document.querySelector(`#mobile-turn-target`),mobileTurnOptionAButton:document.querySelector(`#mobile-turn-option-a`),mobileTurnOptionBButton:document.querySelector(`#mobile-turn-option-b`),mobileTurnOptionCButton:document.querySelector(`#mobile-turn-option-c`),mobileTurnOptionDButton:document.querySelector(`#mobile-turn-option-d`),mobileTurnBackButton:document.querySelector(`#mobile-turn-back-button`),mobileTurnCancelButton:document.querySelector(`#mobile-turn-cancel-button`),cubeStageEl:i}},bc=new Set([`r`,`F`,`u`,`U`,`d`,`D`,`e`,`E`]),xc=e=>{let t=e.toUpperCase();return e===e.toLowerCase()?t:`${t}'`},Sc=(e,t)=>t?e===`U`||e===`u`||e===t?{allowed:!0}:{allowed:!1,message:`工作區已移動，僅可做 ${xc(t)} 或 U/U'`}:bc.has(e)?{allowed:!0}:{allowed:!1,message:`工作區剛啟用，僅可做 R、F'、U、U'、D、D'、E、E'`},Cc=e=>[{...e[0]},{...e[1]},{...e[2]}],wc=(e,t)=>{let n=e=>e.map(e=>`${e.x},${e.y},${e.z}`).sort().join(`|`);return n(e)===n(t)},Tc=(e,t)=>t.layer===0?e[t.axis]===0:e[t.axis]===t.layer,Ec=(e,t)=>{let n=dc(t.notation,t.clockwise),r=t.axis===`x`?new G(1,0,0):t.axis===`y`?new G(0,1,0):new G(0,0,1),i=new G(e.x,e.y,e.z).applyAxisAngle(r,n);return{x:Math.round(i.x),y:Math.round(i.y),z:Math.round(i.z)}},Dc={x:{axis:`x`,layer:0},y:{axis:`y`,layer:0},z:{axis:`z`,layer:0}},Oc=e=>{Object.assign(e,Dc)},kc=()=>`
...
`,Ac=e=>e.map(e=>e.replace(/面$/,``)).join(`/`),jc=e=>{let{targets:t,pieceFaceInfoByNotation:n,centerFaceInfoByNotation:r,middleLayerNotation:i}=e,a=t.map(e=>{let t=n[e.notation];return t?`${t.label}面`:null});if(a[0]===null||a[1]===null)return null;let o=t.map(e=>{let t=r[e.notation];return t?{label:`${t.label}面`,faceColor:t.faceColor,notation:e.notation}:null});return o[0]===null||o[1]===null?null:{targetText:Ac([a[0],a[1]]),options:[o[0],o[1],{label:`中間層`,notation:i}]}},Mc=e=>{let{targets:t,pieceFaceInfoByNotation:n,centerFaceInfoByNotation:r}=e,i=t.map(e=>{let t=n[e.notation];return t?`${t.label}面`:null});if(i[0]===null||i[1]===null||i[2]===null)return null;let a=t.map(e=>{let t=r[e.notation];return t?{label:`${t.label}面`,faceColor:t.faceColor,notation:e.notation}:null});return a[0]===null||a[1]===null||a[2]===null?null:{targetText:Ac([i[0],i[1],i[2]]),options:[a[0],a[1],a[2]]}},Nc={x:{[-1]:{axis:`x`,sign:-1,notation:`l`},1:{axis:`x`,sign:1,notation:`r`}},y:{[-1]:{axis:`y`,sign:-1,notation:`d`},1:{axis:`y`,sign:1,notation:`u`}},z:{[-1]:{axis:`z`,sign:-1,notation:`b`},1:{axis:`z`,sign:1,notation:`f`}}},Pc=e=>{let t=[[`x`,e.x],[`y`,e.y],[`z`,e.z]].filter(([,e])=>e!==0);if(t.length!==2)return null;let[n,r]=t,[i,a]=n,[o,s]=r;return Math.abs(a)!==1&&Math.abs(s)!==1||Math.abs(a)+Math.abs(s)!==2?null:[Nc[i][a],Nc[o][s]]},Fc=e=>{let t=[[`x`,e.x],[`y`,e.y],[`z`,e.z]];return t.some(([,e])=>Math.abs(e)!==1)?null:t.map(([e,t])=>Nc[e][t])},Ic=e=>{let t=[[`x`,e.x],[`y`,e.y],[`z`,e.z]],n=t.filter(([,e])=>e===0);if(n.length!==1)return null;let r=t.filter(([,e])=>e!==0);if(r.length!==2||r.some(([,e])=>Math.abs(e)!==1))return null;let[i]=n[0];return i===`x`?`m`:i===`y`?`e`:`s`},Lc=(e,t)=>(e.sign===1?t:!t)?e.axis:e.axis.toUpperCase(),Rc=(e,t)=>t?e:e.toUpperCase(),zc=()=>({renderView:kc,registerMoveBindings:Oc}),Bc=()=>{let e=[],t=[],n=0,r=null,i=null,a=e=>e===e.toLowerCase()?e.toUpperCase():e.toLowerCase();return{initialize:t=>{e.push(t)},hydrate:a=>a.stateHistory.length!==a.moveHistory.length+1||a.currentHistoryIndex<0||a.currentHistoryIndex>a.moveHistory.length?!1:(e.splice(0,e.length,...a.stateHistory),t.splice(0,t.length,...a.moveHistory),n=a.currentHistoryIndex,r=null,i=null,!0),trimFutureHistory:()=>{n!==t.length&&(t.splice(n),e.splice(n+1))},appendMove:(r,i)=>{t.push(r),e.push(i),n=t.length},queueJump:e=>{r=e},queueStep:e=>{i=e},consumeQueuedJump:()=>{if(r===null)return null;let e=r;return r=null,e},consumeQueuedStep:()=>{if(i===null)return null;let e=i;return i=null,e},jumpTo:t=>{let r=e[t];if(r!==void 0)return n=t,r},getStepInstruction:e=>{if(e===1)return n>=t.length?null:{notation:t[n],targetIndex:n+1};if(n<=0)return null;let r=t[n-1];return r?{notation:a(r),targetIndex:n-1}:null},setCurrentIndex:e=>e<0||e>t.length?!1:(n=e,!0),getViewItems:()=>{let e=[{index:0,notation:null,isCurrent:n===0}];for(let r=0;r<t.length;r+=1)e.push({index:r+1,notation:t[r],isCurrent:n===r+1});return e},getNotationAtIndex:e=>e<=0||e>t.length?null:t[e-1]??null,exportSnapshot:()=>({stateHistory:[...e],moveHistory:[...t],currentHistoryIndex:n}),getDebugState:()=>({moveHistory:[...t],currentHistoryIndex:n,queuedHistoryRestoreIndex:r,queuedStepDirection:i,stateCount:e.length})}},Vc=e=>{let t=e.toUpperCase();return e===e.toLowerCase()?t:`${t}'`},Hc=({historyListEl:e,captureState:t,restoreState:n,clearPendingMoves:r,setStatus:i,isAnimating:a,onHistoryItemSelect:o,onHistoryChange:s})=>{let c=Bc(),l=()=>{s?.()},u=()=>{if(!e)return;let t=e.parentElement;t&&(t.scrollTop=t.scrollHeight),e.scrollLeft=e.scrollWidth},d=()=>{e&&(e.innerHTML=c.getViewItems().map(e=>{let t=e.isCurrent?` is-current`:``,n=e.notation===null?`起始`:Vc(e.notation);return`<button type="button" class="history-item${t}" data-history-index="${e.index}">${n}</button>`}).join(``),u())},f=e=>{let t=c.jumpTo(e);return t!==void 0&&(r(),n(t),d(),l(),i(`已復原到步驟 ${e}`),!0)},p=e=>{if(a()){c.queueJump(e),r(),i(`正在等待目前轉動完成，之後復原到步驟 ${e}`);return}f(e)&&i(`待命`)};return{initialize:()=>{c.initialize(t()),d(),l()},hydrate:e=>{if(!c.hydrate(e))return!1;let t=c.jumpTo(e.currentHistoryIndex);return t!==void 0&&(n(t),d(),l(),!0)},onBeforeEnqueueMove:()=>{c.trimFutureHistory(),d(),l()},onMoveCompleted:(e,n={})=>{if(typeof n.historyTargetIndex==`number`){c.setCurrentIndex(n.historyTargetIndex),d(),l();let e=c.consumeQueuedStep();if(e!==null){let t=c.getStepInstruction(e);if(t)return i(`待命`),t}return i(`待命`),null}c.appendMove(e,t()),d(),l();let r=c.consumeQueuedStep();if(r!==null){let e=c.getStepInstruction(r);if(e)return i(`待命`),e}let a=c.consumeQueuedJump();return a===null?null:(f(a),i(`待命`),null)},attachClickHandler:()=>{e?.addEventListener(`click`,e=>{let t=e.target;if(!t)return;let n=t.closest(`.history-item`);if(!n)return;let r=n.dataset.historyIndex;if(typeof r!=`string`)return;let i=Number.parseInt(r,10);if(!Number.isFinite(i))return;let a=c.getNotationAtIndex(i);if(o){o({index:i,notation:a});return}p(i)})},requestJump:p,requestStep:e=>a()?(c.queueStep(e),r(),i(`正在等待目前轉動完成，之後切換歷史步驟`),null):c.getStepInstruction(e),exportSnapshot:c.exportSnapshot,getDebugState:c.getDebugState}},Uc=e=>({captureState:()=>e.map(e=>({position:e.position.clone(),quaternion:e.quaternion.clone()})),restoreState:t=>{for(let[n,r]of e.entries()){let e=t[n];e&&(r.position.copy(e.position),r.quaternion.copy(e.quaternion),r.rotation.setFromQuaternion(e.quaternion,`XYZ`))}}}),Wc=document.querySelector(`#app`);if(!Wc)throw Error(`Missing #app container`);`serviceWorker`in navigator&&globalThis.addEventListener(`load`,()=>{navigator.serviceWorker.register(`/rubiks/sw.js`,{scope:`/rubiks/`}).catch(e=>{console.warn(`Service worker registration failed`,e)})});var Gc=`2026-08-26T21:37:36+02:00`,Kc=zc(),{scrambleButton:qc,workspaceToggleButton:Jc,repeatLastButton:Yc,historyPrevButton:Xc,historyNextButton:Zc,statusMessageEl:Qc,historyListEl:$c,helpToggleButton:el,helpCloseButton:tl,helpPanelEl:nl,mobileTurnMenuEl:rl,mobileTurnTargetEl:il,mobileTurnOptionAButton:al,mobileTurnOptionBButton:ol,mobileTurnOptionCButton:sl,mobileTurnOptionDButton:cl,mobileTurnBackButton:ll,mobileTurnCancelButton:ul,cubeStageEl:dl}=yc({app:Wc,xyzMarkup:Kc.renderView(),latestCommitTimestamp:Gc}),fl=[al,ol,sl,cl],pl=new cc({antialias:!0});pl.setPixelRatio(Math.min(globalThis.devicePixelRatio,2)),pl.setSize(dl.clientWidth,dl.clientHeight),dl.appendChild(pl.domElement);var ml=new zr;ml.background=new J(`#0f172a`);var hl=new Ar(45,dl.clientWidth/dl.clientHeight,.1,100);hl.position.set(6,6,7),hl.lookAt(0,0,0);var gl=hl.position.clone().normalize(),_l=new Bi(`#ffffff`,.65);ml.add(_l);var vl=new zi(`#ffffff`,.9);vl.position.set(8,10,12),ml.add(vl);var yl=new zi(`#7dd3fc`,.35);yl.position.set(-8,-3,-10),ml.add(yl);var bl=new Ir;ml.add(bl);var xl=new Ir;ml.add(xl);var Sl=[],Cl=new WeakMap,wl=.5,Tl=1.5,El=null,Dl=.95,Ol=1.05,kl=[{x:1,y:1,z:1},{x:1,y:0,z:1},{x:1,y:-1,z:1}],Al=new vt(new G(-1.05-Dl/2,-1.05-Dl/2,-1.05-Dl/2),new G(1.525,1.525,1.525)),jl=[],Ml={right:`#f97316`,left:`#ef4444`,up:`#facc15`,down:`#f8fafc`,front:`#22c55e`,back:`#3b82f6`,inner:`#111827`},Nl={[new J(Ml.right).getHexString()]:`橘色`,[new J(Ml.left).getHexString()]:`紅色`,[new J(Ml.up).getHexString()]:`黃色`,[new J(Ml.down).getHexString()]:`白色`,[new J(Ml.front).getHexString()]:`綠色`,[new J(Ml.back).getHexString()]:`藍色`},Pl=[{materialIndex:0,normal:new G(1,0,0)},{materialIndex:1,normal:new G(-1,0,0)},{materialIndex:2,normal:new G(0,1,0)},{materialIndex:3,normal:new G(0,-1,0)},{materialIndex:4,normal:new G(0,0,1)},{materialIndex:5,normal:new G(0,0,-1)}],Fl=e=>{let t=Math.PI/2;return Math.round(e/t)*t},Il=new _i({color:`#ffffff`,dashSize:.13,gapSize:.08,transparent:!0,opacity:.95}),Ll=(e,t,n)=>{let r=new _r(e,t,n),i=new fi(r);return r.dispose(),i},Rl=new oi(Ll(1,1,1),Il);xl.add(Rl);var zl=e=>{let t=new G(1/0,1/0,1/0),n=new G(-1/0,-1/0,-1/0);for(let r of e){let e=r.x*Ol,i=r.y*Ol,a=r.z*Ol;t.x=Math.min(t.x,e),t.y=Math.min(t.y,i),t.z=Math.min(t.z,a),n.x=Math.max(n.x,e),n.y=Math.max(n.y,i),n.z=Math.max(n.z,a)}return t.addScalar(-.5549999999999999),n.addScalar(.5549999999999999),{min:t,max:n}},Bl=e=>{let{min:t,max:n}=zl(e),r=n.x-t.x,i=n.y-t.y,a=n.z-t.z,o=Rl.geometry;Rl.geometry=Ll(r,i,a),o.dispose(),Rl.position.set((t.x+n.x)/2,(t.y+n.y)/2,(t.z+n.z)/2),Rl.computeLineDistances()},Vl=[{...kl[0]},{...kl[1]},{...kl[2]}],Hl=!1,Ul=null;for(let e of[Al.min.x,Al.max.x])for(let t of[Al.min.y,Al.max.y])for(let n of[Al.min.z,Al.max.z])jl.push(new G(e,t,n));for(let e=-1;e<=1;e+=1)for(let t=-1;t<=1;t+=1)for(let n=-1;n<=1;n+=1){let r=new _r(Dl,Dl,Dl),i=[new mi({color:e===1?Ml.right:Ml.inner}),new mi({color:e===-1?Ml.left:Ml.inner}),new mi({color:t===1?Ml.up:Ml.inner}),new mi({color:t===-1?Ml.down:Ml.inner}),new mi({color:n===1?Ml.front:Ml.inner}),new mi({color:n===-1?Ml.back:Ml.inner})],a=new mr(r,i);Cl.set(a,i.map(e=>e.color.getHex())),a.position.set(e*Ol,t*Ol,n*Ol),bl.add(a),Sl.push(a)}Bl(Vl),xl.visible=!1;var Wl=()=>{let e=Cc(kl);for(let t=0;t<Vl.length;t+=1)Vl[t].x=e[t].x,Vl[t].y=e[t].y,Vl[t].z=e[t].z;Ul=null,Bl(Vl)},Gl=()=>{Jc&&(Jc.textContent=Hl?`工作區：開`:`工作區：關`,Jc.setAttribute(`aria-pressed`,Hl?`true`:`false`),Jc.classList.toggle(`is-active`,Hl))},Kl=()=>{qc&&(qc.disabled=!1,qc.setAttribute(`aria-disabled`,Hl?`true`:`false`),qc.classList.toggle(`is-disabled`,Hl),qc.setAttribute(`title`,Hl?`工作區模式開啟時不可打亂`:`打亂魔術方塊`))},ql=e=>{Hl=e,Hl&&(Wl(),Q(`工作區模式開啟，打亂已停用`)),xl.visible=Hl,Gl(),Kl()};Gl(),Kl();var Jl=(e,t)=>{let n=Array.isArray(e.material)?e.material:null,r=Cl.get(e);if(!(!n||!r))for(let e=0;e<n.length;e+=1){let i=n[e];i instanceof mi&&(i.color.setHex(r[e]),t!==null&&i.color.multiplyScalar(t))}},Yl=e=>{El=e;for(let e of Sl){if(El===null){Jl(e,null);continue}if(e===El){Jl(e,Tl);continue}Jl(e,wl)}},Xl=lc();Kc.registerMoveBindings(Xl);var Q=e=>{Qc&&(Qc.textContent=e)};Q(`待命`);var Zl=e=>e,Ql=e=>{let t=e.toUpperCase(),n=e!==e.toLowerCase(),r=n?`${t}'`:t;return t===`X`||t===`Y`||t===`Z`?`${r} ${n?`↺`:`↻`}`:t===`U`?`${r} ${n?`→`:`←`}`:t===`D`?`${r} ${n?`←`:`→`}`:t===`R`?`${r} ${n?`↓`:`↑`}`:t===`F`||t===`L`?`${r} ${n?`↑`:`↓`}`:t===`B`?`${r} ${n?`↓`:`↑`}`:t===`E`||t===`S`?`${r} ${n?`←`:`→`}`:t===`M`?`${r} ${n?`↑`:`↓`}`:r},$l=e=>`已選面：${e.label}（再選轉動方向）`,eu=e=>e.axis===`x`?e.sign===1?`r`:`l`:e.axis===`y`?e.sign===1?`u`:`d`:e.sign===1?`f`:`b`,tu=new ea,nu=new W,$=null,ru=[],iu=()=>$!==null,au=()=>{let e=ru.length>0;ll&&(ll.hidden=!e),ul&&(ul.hidden=e)},ou=()=>{rl&&(rl.hidden=!0,Yl(null),$=null,ru.length=0,au())},su=e=>{e&&(e.style.removeProperty(`background-color`),e.style.removeProperty(`border-color`),e.style.removeProperty(`color`))},cu=(e,t)=>{if(!e)return;if(!t){su(e);return}let n=new J(t),r=n.r*.2126+n.g*.7152+n.b*.0722,i=n.clone().multiplyScalar(.72).getStyle();e.style.backgroundColor=n.getStyle(),e.style.borderColor=i,e.style.color=r>.66?`#0f172a`:`#f8fafc`},lu=e=>{let t=()=>{for(let e of fl)su(e)};if(e.kind===`edge-face`){cu(al,e.options[0].faceColor),cu(ol,e.options[1].faceColor),su(sl),su(cl);return}if(e.kind===`corner-face`){cu(al,e.options[0].faceColor),cu(ol,e.options[1].faceColor),cu(sl,e.options[2].faceColor),su(cl);return}if(e.kind===`center-direction`){t();return}t()},uu=e=>{el?.setAttribute(`aria-expanded`,e?`true`:`false`)},du=()=>{nl&&(nl.hidden=!0,uu(!1))},fu=()=>{nl&&(nl.hidden=!1,uu(!0))},pu=(e,t,n,r=!1)=>{if(rl){r?$&&ru.push($):ru.length=0,$=e,au(),il&&(il.textContent=t);for(let e=0;e<fl.length;e+=1){let t=fl[e];if(!t)continue;let r=n[e];if(r===void 0){t.hidden=!0;continue}t.textContent=r,t.hidden=!1}lu(e),rl.hidden=!1}},mu=(e,t)=>{let n=Lc(e,!0),r=Lc(e,!1),i=eu(e),a=Rc(i,!0),o=Rc(i,!1);pu({kind:`center-direction`,selection:e,colorLabel:t},Zl(t),[Ql(n),Ql(r),Ql(a),Ql(o)],!1)},hu=(e,t)=>{pu({kind:`edge-face`,options:e,targetText:t},t,[e[0].label,e[1].label,e[2].label],!1)},gu=(e,t)=>{pu({kind:`corner-face`,options:e,targetText:t},t,[e[0].label,e[1].label,e[2].label],!1)},_u=(e,t=!1)=>{let n=Rc(e.notation,!0),r=Rc(e.notation,!1);pu({kind:`face-direction`,face:e},$l(e),[Ql(n),Ql(r)],t)},vu=e=>{let t=e.notation?`已選動作：${Ql(e.notation)}`:`已選起始狀態`;pu({kind:`history-action`,index:e.index,notation:e.notation},t,[`再一次`,`恢復狀態`,`逆做`],!1)},yu=e=>{if(!$){ou();return}if($.kind===`center-direction`){let t=Lc($.selection,!0),n=Lc($.selection,!1),r=eu($.selection);Vu([t,n,Rc(r,!0),Rc(r,!1)][e],{allowDuringMenu:!0}),ou();return}if($.kind===`edge-face`||$.kind===`corner-face`){let t=$.options[e];if(!t){ou();return}_u(t,!0);return}if($.kind===`history-action`){if(e===0){if(!$.notation){Q(`起始狀態沒有可再做的動作`),ou();return}Vu($.notation,{allowDuringMenu:!0}),ou();return}if(e===1){zu.requestJump($.index),ou();return}if(e===2){if(!$.notation){Q(`起始狀態沒有可逆做的動作`),ou();return}Vu(Wu($.notation),{allowDuringMenu:!0}),ou();return}ou();return}if(e===0||e===1){Vu(Rc($.face.notation,e===0),{allowDuringMenu:!0}),ou();return}ou()},bu=e=>{let t=Math.round(e/Ol);return Math.abs(e-t*Ol)<.001?t:null},xu=e=>{let t=bu(e.position.x),n=bu(e.position.y),r=bu(e.position.z);return t===null||n===null||r===null?null:{x:t,y:n,z:r}},Su=e=>{let t=xu(e);if(!t)return null;let{x:n,y:r,z:i}=t;return Math.abs(n)===1&&r===0&&i===0?{axis:`x`,sign:n}:Math.abs(r)===1&&n===0&&i===0?{axis:`y`,sign:r}:Math.abs(i)===1&&n===0&&r===0?{axis:`z`,sign:i}:null},Cu=e=>{let t=Math.abs(e.x),n=Math.abs(e.y),r=Math.abs(e.z),i=Math.max(t,n,r);return i<.85?null:t===i?e.x>=0?`r`:`l`:n===i?e.y>=0?`u`:`d`:e.z>=0?`f`:`b`},wu=e=>{let t={},n=Array.isArray(e.material)?e.material:null;if(!n)return t;for(let r of Pl){let i=n[r.materialIndex];if(!(i instanceof mi))continue;let a=Cu(r.normal.clone().applyQuaternion(e.quaternion));if(!a)continue;let o=Nl[i.color.getHexString()];o&&(t[a]={label:o,faceColor:`#${i.color.getHexString()}`})}return t},Tu=()=>{let e={};for(let t of Sl){let n=Su(t);if(!n)continue;let r=eu(n),i=wu(t)[r];i&&(e[r]=i)}return e},Eu=e=>{let t=xu(e);if(!t)return null;let n=Pc(t);if(!n)return null;let r=Ic(t);return r?jc({targets:n,pieceFaceInfoByNotation:wu(e),centerFaceInfoByNotation:Tu(),middleLayerNotation:r}):null},Du=e=>{let t=xu(e);if(!t)return null;let n=Fc(t);return n?Mc({targets:n,pieceFaceInfoByNotation:wu(e),centerFaceInfoByNotation:Tu()}):null},Ou=e=>new Promise(t=>setTimeout(t,e)),ku=Uc(Sl),Au=`rubiks-state-v1`,ju=e=>({position:[e.position.x,e.position.y,e.position.z],quaternion:[e.quaternion.x,e.quaternion.y,e.quaternion.z,e.quaternion.w]}),Mu=e=>typeof e==`number`&&Number.isFinite(e),Nu=e=>{if(!e||typeof e!=`object`)return null;let{position:t,quaternion:n}=e;return!Array.isArray(t)||t.length!==3||!t.every(Mu)||!Array.isArray(n)||n.length!==4||!n.every(Mu)?null:{position:new G(...t),quaternion:new We(...n)}},Pu=()=>{try{let e=globalThis.localStorage?.getItem(Au);if(!e)return null;let t=JSON.parse(e);return t.version!==1||t.lastExecutedNotation!==null&&typeof t.lastExecutedNotation!=`string`||!t.history||!Array.isArray(t.history.stateHistory)||!Array.isArray(t.history.moveHistory)||!t.history.moveHistory.every(e=>typeof e==`string`)||!Number.isInteger(t.history.currentHistoryIndex)?null:t}catch(e){return console.warn(`Failed to load saved Rubik state`,e),null}},Fu=()=>{try{globalThis.localStorage?.removeItem(Au)}catch(e){console.warn(`Failed to clear saved Rubik state`,e)}},Iu=e=>{let t=[];for(let n of e){if(!Array.isArray(n)||n.length!==Sl.length)return null;let e=n.map(Nu);if(e.some(e=>e===null))return null;t.push(e)}return t},Lu,Ru=null,zu=Hc({historyListEl:$c,captureState:ku.captureState,restoreState:ku.restoreState,clearPendingMoves:()=>{Lu.clearPending()},setStatus:Q,isAnimating:()=>Lu.isAnimating(),onHistoryItemSelect:e=>{if(iu()){Q(`請先完成目前互動選單`);return}vu(e)},onHistoryChange:()=>{try{let e=zu.exportSnapshot(),t={version:1,lastExecutedNotation:Ru,history:{moveHistory:e.moveHistory,currentHistoryIndex:e.currentHistoryIndex,stateHistory:e.stateHistory.map(e=>e.map(ju))}};globalThis.localStorage?.setItem(Au,JSON.stringify(t))}catch(e){console.warn(`Failed to save Rubik state`,e)}}}),Bu=e=>{let{axis:t,layer:n,notation:r}=e;if(n===0){let e=r.toLowerCase();return e===`x`||e===`y`||e===`z`?Sl:Sl.filter(e=>Math.abs(e.position[t])<.001)}let i=n*Ol;return Sl.filter(e=>Math.abs(e.position[t]-i)<.001)};Lu=fc({runMove:(e,t)=>{let{axis:n,layer:r,clockwise:i,notation:a}=e,o=Cc(Vl),s=Bu(e),c=a.toLowerCase(),l=Hl&&(c===`r`||c===`f`)&&Vl.every(t=>Tc(t,e));if(s.length===0){t();return}let u=new Ir;bl.add(u);for(let e of s)u.attach(e);Q(`轉動 ${a}`);let d=dc(a,i),f=performance.now(),p=r=>{let i=r-f,c=Math.min(i/220,1),m=1-(1-c)**3;if(u.rotation[n]=d*m,c<1){requestAnimationFrame(p);return}for(let e of s){bl.attach(e),e.position.set(Math.round(e.position.x/Ol)*Ol,Math.round(e.position.y/Ol)*Ol,Math.round(e.position.z/Ol)*Ol);let t=new tn().setFromQuaternion(e.quaternion,`XYZ`);e.rotation.set(Fl(t.x),Fl(t.y),Fl(t.z),`XYZ`)}if(bl.remove(u),l){for(let t=0;t<Vl.length;t+=1){let n=Ec(Vl[t],e);Vl[t].x=n.x,Vl[t].y=n.y,Vl[t].z=n.z}Bl(Vl),Ul=Ul&&a===Ul.requiredInverseNotation&&wc(Vl,Ul.restorePositions)?null:{requiredInverseNotation:mc(a),restorePositions:o}}Ru=e.notation;let h=zu.onMoveCompleted(e.notation,{historyTargetIndex:e.historyTargetIndex});h&&Vu(h.notation,{skipHistoryTrim:!0,historyTargetIndex:h.targetIndex}),Q(`待命`),t()};requestAnimationFrame(p)},onIdle:()=>Q(`待命`)});var Vu=(e,t={})=>{if(iu()&&!t.allowDuringMenu){Q(`請先完成目前互動選單`);return}let n=e.toLowerCase(),r=Xl[n];if(!r)return;if(Hl){let t=Sc(e,Ul?.requiredInverseNotation??null);if(!t.allowed){Q(t.message??`此動作目前不可用`);return}}t.skipHistoryTrim||zu.onBeforeEnqueueMove();let i=e===n;Lu.enqueue({axis:r.axis,layer:r.layer,clockwise:i,notation:e,historyTargetIndex:t.historyTargetIndex})},Hu=e=>{if(iu()){Q(`請先完成目前互動選單`);return}let t=zu.requestStep(e);if(!t){Q(e===-1?`已經是最前一步`:`已經是最新一步`);return}Vu(t.notation,{skipHistoryTrim:!0,historyTargetIndex:t.targetIndex})},Uu=e=>{for(let t of e)Vu(t)},Wu=e=>e.split(``).reverse().map(e=>mc(e)).join(``),Gu=()=>{for(let e of Sl){let t=Math.round(e.position.x/Ol)*Ol,n=Math.round(e.position.y/Ol)*Ol,r=Math.round(e.position.z/Ol)*Ol;if(Math.abs(e.position.x-t)>.001||Math.abs(e.position.y-n)>.001||Math.abs(e.position.z-r)>.001)return!1;let i=new tn().setFromQuaternion(e.quaternion,`XYZ`);if(Math.abs(i.x-Fl(i.x))>.001||Math.abs(i.y-Fl(i.y))>.001||Math.abs(i.z-Fl(i.z))>.001)return!1}return Sl.every(e=>{let t=e.userData.home;return t?Math.abs(e.position.x-t.x)<.001&&Math.abs(e.position.y-t.y)<.001&&Math.abs(e.position.z-t.z)<.001&&Math.abs(e.quaternion.x)<.001&&Math.abs(e.quaternion.y)<.001&&Math.abs(e.quaternion.z)<.001&&Math.abs(e.quaternion.w-1)<.001:!1})},Ku=async()=>{for(;Lu.isAnimating()||Lu.getQueueLength()>0;)await Ou(20)},qu=gc({setStatus:Q,enqueueAlgorithm:Uu});for(let e of Sl)e.userData.home={x:e.position.x,y:e.position.y,z:e.position.z};(()=>{let e=Pu();if(!e)return!1;let t=Iu(e.history.stateHistory);return!t||!zu.hydrate({stateHistory:t,moveHistory:e.history.moveHistory,currentHistoryIndex:e.history.currentHistoryIndex})?(Fu(),!1):(Ru=e.lastExecutedNotation,Q(`已載入上次狀態`),!0)})()||zu.initialize(),zu.attachClickHandler();var Ju=()=>iu()?(Q(`請先完成目前互動選單`),!1):Lu.isAnimating()||Lu.getQueueLength()>0?(Q(`請等目前動作完成後再切換工作區`),!1):(ql(!Hl),!0);Jc?.addEventListener(`click`,()=>{Ju()}),globalThis.addEventListener(`keydown`,e=>{if(e.key!==`w`&&e.key!==`W`)return;let t=e.target;t instanceof HTMLInputElement||t instanceof HTMLTextAreaElement||t instanceof HTMLElement&&t.isContentEditable||Ju()&&e.preventDefault()}),qc?.addEventListener(`click`,()=>{if(iu()){Q(`請先完成目前互動選單`);return}if(Hl){Q(`工作區模式開啟時不可打亂`);return}if(!globalThis.confirm(`確定要打亂嗎？`)){Q(`已取消打亂`);return}qu.triggerScramble()}),Yc?.addEventListener(`click`,()=>{if(iu()){Q(`請先完成目前互動選單`);return}if(!Ru){Q(`目前沒有可再執行的最後動作`);return}Vu(Ru)}),Xc?.addEventListener(`click`,()=>{Hu(-1)}),Zc?.addEventListener(`click`,()=>{Hu(1)}),el?.addEventListener(`click`,()=>{if(nl?.hidden){fu();return}du()}),tl?.addEventListener(`click`,()=>{du()}),nl?.addEventListener(`click`,e=>{e.target===nl&&du()}),al?.addEventListener(`click`,()=>{yu(0)}),ol?.addEventListener(`click`,()=>{yu(1)}),sl?.addEventListener(`click`,()=>{yu(2)}),cl?.addEventListener(`click`,()=>{yu(3)}),ll?.addEventListener(`click`,()=>{if(!$){Q(`目前沒有可返回的互動步驟`),ou();return}let e=ru.pop();if(!e){Q(`已經是第一步，無法再返回`),ou();return}if(e.kind===`center-direction`){mu(e.selection,e.colorLabel);return}if(e.kind===`edge-face`){hu(e.options,e.targetText);return}if(e.kind===`corner-face`){gu(e.options,e.targetText);return}if(e.kind===`history-action`){vu({index:e.index,notation:e.notation});return}_u(e.face,!1)}),ul?.addEventListener(`click`,()=>{if(!$){Q(`目前沒有進行中的互動選單`);return}ou()}),rl?.addEventListener(`click`,e=>{e.target===rl&&ou()}),pl.domElement.addEventListener(`click`,e=>{if(iu())return;let t=pl.domElement.getBoundingClientRect();nu.x=(e.clientX-t.left)/t.width*2-1,nu.y=-((e.clientY-t.top)/t.height)*2+1,tu.setFromCamera(nu,hl);let n=tu.intersectObjects(Sl,!1);if(n.length===0)return;let r=n.map(e=>e.object).find(e=>e instanceof mr);if(!r)return;let i=Su(r);if(i){let e=eu(i),t=wu(r)[e]?.label;if(!t)return;Yl(r),mu(i,t);return}let a=Eu(r);if(a){Yl(r),hu(a.options,a.targetText);return}let o=Du(r);o&&(Yl(r),gu(o.options,o.targetText))}),pc({moveMap:Xl,enqueueMoveByNotation:Vu});var Yu=()=>{pl.render(ml,hl),requestAnimationFrame(Yu)};Yu();var Xu=()=>{let e=Math.max(dl.clientWidth,1),t=Math.max(dl.clientHeight,1);hl.aspect=e/t;let n=e=>{hl.position.copy(gl).multiplyScalar(e),hl.lookAt(0,0,0),hl.updateMatrixWorld();let t=0,n=0;for(let e of jl){let r=e.clone().project(hl);t=Math.max(t,Math.abs(r.x)),n=Math.max(n,Math.abs(r.y))}return Math.max(t,n)},r=2,i=24;for(let e=0;e<22;e+=1){let e=(r+i)/2;n(e)>.96?r=e:i=e}hl.position.copy(gl).multiplyScalar(i),hl.lookAt(0,0,0),hl.updateProjectionMatrix(),pl.setSize(e,t)};Xu(),new ResizeObserver(()=>{Xu()}).observe(dl),globalThis.addEventListener(`resize`,()=>{Xu()}),_c({enqueueMoveByNotation:Vu,enqueueAlgorithm:Uu,invertAlgorithm:Wu,isSolved:Gu,waitForIdle:Ku,getLastScramble:qu.getLastScramble,getQueueLength:()=>Lu.getQueueLength(),isAnimating:()=>Lu.isAnimating()});