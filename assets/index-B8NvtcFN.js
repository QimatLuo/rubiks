...
`;var mc=document.querySelector(`#scramble-button`),hc=document.querySelector(`#repeat-last-button`),gc=document.querySelector(`#history-prev-button`),_c=document.querySelector(`#history-next-button`),vc=document.querySelector(`#move-history-list`),yc=document.querySelector(`#help-toggle-button`),bc=document.querySelector(`#help-close-button`),xc=document.querySelector(`#help-panel`),Sc=document.querySelector(`#mobile-turn-menu`),Cc=document.querySelector(`#mobile-turn-target`),wc=document.querySelector(`#mobile-turn-option-a`),Tc=document.querySelector(`#mobile-turn-option-b`),Ec=document.querySelector(`#mobile-turn-option-c`),Dc=document.querySelector(`#mobile-turn-back-button`),Oc=document.querySelector(`#mobile-turn-cancel-button`),kc=document.querySelector(`#cube-stage`);if(!kc)throw Error(`Missing #cube-stage container`);var Ac=new Us({antialias:!0});Ac.setPixelRatio(Math.min(globalThis.devicePixelRatio,2)),Ac.setSize(kc.clientWidth,kc.clientHeight),kc.appendChild(Ac.domElement);var jc=new zr;jc.background=new J(`#0f172a`);var Mc=new Ar(45,kc.clientWidth/kc.clientHeight,.1,100);Mc.position.set(6,6,7),Mc.lookAt(0,0,0);var Nc=Mc.position.clone().normalize(),Pc=new xi(`#ffffff`,.65);jc.add(Pc);var Fc=new bi(`#ffffff`,.9);Fc.position.set(8,10,12),jc.add(Fc);var Ic=new bi(`#7dd3fc`,.35);Ic.position.set(-8,-3,-10),jc.add(Ic);var Lc=new Ir;jc.add(Lc);var Rc=[],zc=new WeakMap,Bc=.5,Vc=1.5,Hc=null,Uc=.95,Wc=1.05,Gc=new vt(new G(-1.05-Uc/2,-1.05-Uc/2,-1.05-Uc/2),new G(1.525,1.525,1.525)),Kc=[],Q={right:`#f97316`,left:`#ef4444`,up:`#facc15`,down:`#f8fafc`,front:`#22c55e`,back:`#3b82f6`,inner:`#111827`},qc={[new J(Q.right).getHexString()]:`橘色`,[new J(Q.left).getHexString()]:`紅色`,[new J(Q.up).getHexString()]:`黃色`,[new J(Q.down).getHexString()]:`白色`,[new J(Q.front).getHexString()]:`綠色`,[new J(Q.back).getHexString()]:`藍色`};Q.right,Q.left,Q.up,Q.down,Q.front,Q.back;var Jc={橘色:Q.right,紅色:Q.left,黃色:Q.up,白色:Q.down,綠色:Q.front,藍色:Q.back},Yc={r:`橘色`,l:`紅色`,u:`黃色`,d:`白色`,f:`綠色`,b:`藍色`},Xc=[{materialIndex:0,normal:new G(1,0,0)},{materialIndex:1,normal:new G(-1,0,0)},{materialIndex:2,normal:new G(0,1,0)},{materialIndex:3,normal:new G(0,-1,0)},{materialIndex:4,normal:new G(0,0,1)},{materialIndex:5,normal:new G(0,0,-1)}],Zc=e=>{let t=Math.PI/2;return Math.round(e/t)*t};for(let e of[Gc.min.x,Gc.max.x])for(let t of[Gc.min.y,Gc.max.y])for(let n of[Gc.min.z,Gc.max.z])Kc.push(new G(e,t,n));for(let e=-1;e<=1;e+=1)for(let t=-1;t<=1;t+=1)for(let n=-1;n<=1;n+=1){let r=new _r(Uc,Uc,Uc),i=[new Xr({color:e===1?Q.right:Q.inner}),new Xr({color:e===-1?Q.left:Q.inner}),new Xr({color:t===1?Q.up:Q.inner}),new Xr({color:t===-1?Q.down:Q.inner}),new Xr({color:n===1?Q.front:Q.inner}),new Xr({color:n===-1?Q.back:Q.inner})],a=new mr(r,i);zc.set(a,i.map(e=>e.color.getHex())),a.position.set(e*Wc,t*Wc,n*Wc),Lc.add(a),Rc.push(a)}var Qc=(e,t)=>{let n=Array.isArray(e.material)?e.material:null,r=zc.get(e);if(!(!n||!r))for(let e=0;e<n.length;e+=1){let i=n[e];i instanceof Xr&&(i.color.setHex(r[e]),t!==null&&i.color.multiplyScalar(t))}},$c=e=>{Hc=e;for(let e of Rc){if(Hc===null){Qc(e,null);continue}if(e===Hc){Qc(e,Vc);continue}Qc(e,Bc)}},el=Ws();pc.registerMoveBindings(el);var tl=e=>{},nl=e=>e,rl=e=>`${e[0].label.replace(/面$/,``)}/${e[1].label.replace(/面$/,``)}`,il=e=>e.map(e=>e.label.replace(/面$/,``)).join(`/`),al=e=>{let t=e.toUpperCase(),n=e!==e.toLowerCase(),r=n?`${t}'`:t;return t===`X`||t===`Y`||t===`Z`?`${r} ${n?`↺`:`↻`}`:t===`U`?`${r} ${n?`→`:`←`}`:t===`D`?`${r} ${n?`←`:`→`}`:t===`R`?`${r} ${n?`↓`:`↑`}`:t===`F`||t===`L`?`${r} ${n?`↑`:`↓`}`:t===`B`?`${r} ${n?`↓`:`↑`}`:t===`E`||t===`S`?`${r} ${n?`←`:`→`}`:t===`M`?`${r} ${n?`↑`:`↓`}`:r},ol=e=>`已選面：${e.label}（再選轉動方向）`,sl=e=>e.axis===`x`?e.sign===1?`r`:`l`:e.axis===`y`?e.sign===1?`u`:`d`:e.sign===1?`f`:`b`,cl=new Fi,ll=new W,$=null,ul=[],dl=()=>$!==null,fl=()=>{let e=ul.length>0;Dc&&(Dc.hidden=!e),Oc&&(Oc.hidden=e)},pl=()=>{Sc&&(Sc.hidden=!0,$c(null),$=null,ul.length=0,fl())},ml=e=>{if(!e)return null;for(let[t,n]of Object.entries(Jc))if(e.includes(t))return n;return null},hl=e=>{e&&(e.style.removeProperty(`background-color`),e.style.removeProperty(`border-color`),e.style.removeProperty(`color`))},gl=(e,t)=>{if(!e)return;if(!t){hl(e);return}let n=new J(t),r=n.r*.2126+n.g*.7152+n.b*.0722,i=n.clone().multiplyScalar(.72).getStyle();e.style.backgroundColor=n.getStyle(),e.style.borderColor=i,e.style.color=r>.66?`#0f172a`:`#f8fafc`},_l=()=>{gl(wc,ml(wc?.textContent)),gl(Tc,ml(Tc?.textContent)),gl(Ec,ml(Ec?.textContent))},vl=e=>{yc?.setAttribute(`aria-expanded`,e?`true`:`false`)},yl=()=>{xc&&(xc.hidden=!0,vl(!1))},bl=()=>{xc&&(xc.hidden=!1,vl(!0))},xl=(e,t,n,r=!1)=>{Sc&&(r?$&&ul.push($):ul.length=0,$=e,fl(),Cc&&(Cc.textContent=t),wc&&(wc.textContent=n[0]),Tc&&(Tc.textContent=n[1]),Ec&&(n.length===3?(Ec.textContent=n[2],Ec.hidden=!1):Ec.hidden=!0),_l(),Sc.hidden=!1)},Sl=(e,t)=>{let n=ac(e,!0),r=ac(e,!1);xl({kind:`center-direction`,selection:e},nl(t),[al(n),al(r)],!1)},Cl=e=>{xl({kind:`edge-face`,options:e},rl(e),[e[0].label,e[1].label,e[2].label],!1)},wl=e=>{xl({kind:`corner-face`,options:e},il(e),[e[0].label,e[1].label,e[2].label],!1)},Tl=(e,t=!1)=>{let n=oc(e.notation,!0),r=oc(e.notation,!1);xl({kind:`face-direction`,face:e},ol(e),[al(n),al(r)],t)},El=e=>{let t=e.notation?`已選動作：${al(e.notation)}`:`已選起始狀態`;xl({kind:`history-action`,index:e.index,notation:e.notation},t,[`再一次`,`恢復狀態`,`逆做`],!1)},Dl=e=>{let t=Math.round(e/Wc);return Math.abs(e-t*Wc)<.001?t:null},Ol=e=>{let t=Dl(e.position.x),n=Dl(e.position.y),r=Dl(e.position.z);return t===null||n===null||r===null?null:{x:t,y:n,z:r}},kl=e=>{let t=Ol(e);if(!t)return null;let{x:n,y:r,z:i}=t;return Math.abs(n)===1&&r===0&&i===0?{axis:`x`,sign:n}:Math.abs(r)===1&&n===0&&i===0?{axis:`y`,sign:r}:Math.abs(i)===1&&n===0&&r===0?{axis:`z`,sign:i}:null},Al=e=>{let t=Math.abs(e.x),n=Math.abs(e.y),r=Math.abs(e.z),i=Math.max(t,n,r);return i<.85?null:t===i?e.x>=0?`r`:`l`:n===i?e.y>=0?`u`:`d`:e.z>=0?`f`:`b`},jl=e=>{let t={},n=Array.isArray(e.material)?e.material:null;if(!n)return t;for(let r of Xc){let i=n[r.materialIndex];if(!(i instanceof Xr))continue;let a=Al(r.normal.clone().applyQuaternion(e.quaternion));if(!a)continue;let o=qc[i.color.getHexString()];o&&(t[a]=o)}return t},Ml=e=>{let t=Ol(e);if(!t)return null;let n=nc(t);if(!n)return null;let r=ic(t);if(!r)return null;let i=jl(e),a=n.map(e=>{let t=i[e.notation];return t?{label:`${t}面`,notation:e.notation}:null});return a[0]===null||a[1]===null?null:[a[0],a[1],{label:`中間層`,notation:r}]},Nl=e=>{let t=Ol(e);if(!t)return null;let n=rc(t);if(!n)return null;let r=jl(e),i=n.map(e=>{let t=r[e.notation];return t?{label:`${t}面`,notation:e.notation}:null});return i[0]===null||i[1]===null||i[2]===null?null:[i[0],i[1],i[2]]},Pl=e=>new Promise(t=>setTimeout(t,e)),Fl=dc(Rc),Il,Ll=null,Rl=uc({historyListEl:vc,captureState:Fl.captureState,restoreState:Fl.restoreState,clearPendingMoves:()=>{Il.clearPending()},setStatus:tl,isAnimating:()=>Il.isAnimating(),onHistoryItemSelect:e=>{dl()||El(e)}}),zl=e=>{let{axis:t,layer:n,notation:r}=e;if(n===0){let e=r.toLowerCase();return e===`x`||e===`y`||e===`z`?Rc:Rc.filter(e=>Math.abs(e.position[t])<.001)}let i=n*Wc;return Rc.filter(e=>Math.abs(e.position[t]-i)<.001)};Il=qs({runMove:(e,t)=>{let{axis:n,layer:r,clockwise:i,notation:a}=e,o=zl(e);if(o.length===0){t();return}let s=new Ir;Lc.add(s);for(let e of o)s.attach(e);`${a}`;let c=Ks(a,i),l=performance.now(),u=r=>{let i=r-l,a=Math.min(i/220,1),d=1-(1-a)**3;if(s.rotation[n]=c*d,a<1){requestAnimationFrame(u);return}for(let e of o){Lc.attach(e),e.position.set(Math.round(e.position.x/Wc)*Wc,Math.round(e.position.y/Wc)*Wc,Math.round(e.position.z/Wc)*Wc);let t=new tn().setFromQuaternion(e.quaternion,`XYZ`);e.rotation.set(Zc(t.x),Zc(t.y),Zc(t.z),`XYZ`)}Lc.remove(s),Ll=e.notation;let f=Rl.onMoveCompleted(e.notation,{historyTargetIndex:e.historyTargetIndex});f&&Bl(f.notation,{skipHistoryTrim:!0,historyTargetIndex:f.targetIndex}),t()};requestAnimationFrame(u)},onIdle:()=>void 0});var Bl=(e,t={})=>{if(dl()&&!t.allowDuringMenu)return;let n=e.toLowerCase(),r=el[n];if(!r)return;t.skipHistoryTrim||Rl.onBeforeEnqueueMove();let i=e===n;Il.enqueue({axis:r.axis,layer:r.layer,clockwise:i,notation:e,historyTargetIndex:t.historyTargetIndex})},Vl=e=>{if(dl())return;let t=Rl.requestStep(e);t&&Bl(t.notation,{skipHistoryTrim:!0,historyTargetIndex:t.targetIndex})},Hl=e=>{for(let t of e)Bl(t)},Ul=e=>e.split(``).reverse().map(e=>e===e.toLowerCase()?e.toUpperCase():e.toLowerCase()).join(``),Wl=()=>{for(let e of Rc){let t=Math.round(e.position.x/Wc)*Wc,n=Math.round(e.position.y/Wc)*Wc,r=Math.round(e.position.z/Wc)*Wc;if(Math.abs(e.position.x-t)>.001||Math.abs(e.position.y-n)>.001||Math.abs(e.position.z-r)>.001)return!1;let i=new tn().setFromQuaternion(e.quaternion,`XYZ`);if(Math.abs(i.x-Zc(i.x))>.001||Math.abs(i.y-Zc(i.y))>.001||Math.abs(i.z-Zc(i.z))>.001)return!1}return Rc.every(e=>{let t=e.userData.home;return t?Math.abs(e.position.x-t.x)<.001&&Math.abs(e.position.y-t.y)<.001&&Math.abs(e.position.z-t.z)<.001&&Math.abs(e.quaternion.x)<.001&&Math.abs(e.quaternion.y)<.001&&Math.abs(e.quaternion.z)<.001&&Math.abs(e.quaternion.w-1)<.001:!1})},Gl=async()=>{for(;Il.isAnimating()||Il.getQueueLength()>0;)await Pl(20)},Kl=Xs({setStatus:tl,enqueueAlgorithm:Hl});for(let e of Rc)e.userData.home={x:e.position.x,y:e.position.y,z:e.position.z};Rl.initialize(),Rl.attachClickHandler(),mc?.addEventListener(`click`,()=>{dl()||globalThis.confirm(`確定要打亂嗎？`)&&Kl.triggerScramble()}),hc?.addEventListener(`click`,()=>{dl()||Ll&&Bl(Ll)}),gc?.addEventListener(`click`,()=>{Vl(-1)}),_c?.addEventListener(`click`,()=>{Vl(1)}),yc?.addEventListener(`click`,()=>{if(xc?.hidden){bl();return}yl()}),bc?.addEventListener(`click`,()=>{yl()}),xc?.addEventListener(`click`,e=>{e.target===xc&&yl()}),wc?.addEventListener(`click`,()=>{if(!$){pl();return}if($.kind===`center-direction`){Bl(ac($.selection,!0),{allowDuringMenu:!0}),pl();return}if($.kind===`edge-face`){Tl($.options[0],!0);return}if($.kind===`corner-face`){Tl($.options[0],!0);return}if($.kind===`history-action`){if(!$.notation){pl();return}Bl($.notation,{allowDuringMenu:!0}),pl();return}Bl(oc($.face.notation,!0),{allowDuringMenu:!0}),pl()}),Tc?.addEventListener(`click`,()=>{if(!$){pl();return}if($.kind===`center-direction`){Bl(ac($.selection,!1),{allowDuringMenu:!0}),pl();return}if($.kind===`edge-face`){Tl($.options[1],!0);return}if($.kind===`corner-face`){Tl($.options[1],!0);return}if($.kind===`history-action`){Rl.requestJump($.index),pl();return}Bl(oc($.face.notation,!1),{allowDuringMenu:!0}),pl()}),Ec?.addEventListener(`click`,()=>{if(!$){pl();return}if($.kind===`corner-face`){Tl($.options[2],!0);return}if($.kind===`edge-face`){Tl($.options[2],!0);return}if($.kind===`history-action`){if(!$.notation){pl();return}Bl(Ul($.notation),{allowDuringMenu:!0}),pl();return}pl()}),Dc?.addEventListener(`click`,()=>{if(!$){pl();return}let e=ul.pop();if(!e){pl();return}if(e.kind===`center-direction`){let t=sl(e.selection);Sl(e.selection,Yc[t]);return}if(e.kind===`edge-face`){Cl(e.options);return}if(e.kind===`corner-face`){wl(e.options);return}if(e.kind===`history-action`){El({index:e.index,notation:e.notation});return}Tl(e.face,!1)}),Oc?.addEventListener(`click`,()=>{pl()}),Sc?.addEventListener(`click`,e=>{e.target===Sc&&pl()}),Ac.domElement.addEventListener(`click`,e=>{if(dl())return;let t=Ac.domElement.getBoundingClientRect();ll.x=(e.clientX-t.left)/t.width*2-1,ll.y=-((e.clientY-t.top)/t.height)*2+1,cl.setFromCamera(ll,Mc);let n=cl.intersectObjects(Rc,!1);if(n.length===0)return;let r=n.map(e=>e.object).find(e=>e instanceof mr);if(!r)return;let i=kl(r);if(i){let e=sl(i),t=jl(r)[e];if(!t)return;$c(r),Sl(i,t);return}let a=Ml(r);if(a){$c(r),Cl(a);return}let o=Nl(r);o&&($c(r),wl(o))}),Js({moveMap:el,enqueueMoveByNotation:Bl});var ql=()=>{Ac.render(jc,Mc),requestAnimationFrame(ql)};ql();var Jl=()=>{let e=Math.max(kc.clientWidth,1),t=Math.max(kc.clientHeight,1);Mc.aspect=e/t;let n=e=>{Mc.position.copy(Nc).multiplyScalar(e),Mc.lookAt(0,0,0),Mc.updateMatrixWorld();let t=0,n=0;for(let e of Kc){let r=e.clone().project(Mc);t=Math.max(t,Math.abs(r.x)),n=Math.max(n,Math.abs(r.y))}return Math.max(t,n)},r=2,i=24;for(let e=0;e<22;e+=1){let e=(r+i)/2;n(e)>.96?r=e:i=e}Mc.position.copy(Nc).multiplyScalar(i),Mc.lookAt(0,0,0),Mc.updateProjectionMatrix(),Ac.setSize(e,t)};Jl(),new ResizeObserver(()=>{Jl()}).observe(kc),globalThis.addEventListener(`resize`,()=>{Jl()}),Zs({enqueueMoveByNotation:Bl,enqueueAlgorithm:Hl,invertAlgorithm:Ul,isSolved:Wl,waitForIdle:Gl,getLastScramble:Kl.getLastScramble,getQueueLength:()=>Il.getQueueLength(),isAnimating:()=>Il.isAnimating()});